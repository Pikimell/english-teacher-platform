...
`):""}const ke=document.querySelector(".js-practice-section"),m=document.querySelector("[data-practice-generator]"),V=m==null?void 0:m.querySelector("[data-practice-status]"),Q=document.querySelector("[data-generator-output]"),D=document.querySelector("[data-generator-json]"),L=document.querySelector("[data-generator-copy]"),P=document.querySelector("[data-generator-download]"),W=m==null?void 0:m.querySelector("[data-types]"),S=m==null?void 0:m.querySelector("[data-types-trigger]"),M=m==null?void 0:m.querySelector("[data-types-panel]"),ve=document.querySelector("[data-practice-placeholder]"),b=window.lessonContext||{};let C=b.title||"Generated Practice",I=b.level||"custom";const N=[],K=[];function q(e){e&&e.classList.add("hidden")}function le(e){e&&e.classList.remove("hidden")}function _e(e){return!e||e.classList.contains("hidden")}function ce(){return localStorage.getItem("hideGenerateSection")==="true"}function ne(){ce()?(q(ke),q(M),q(Q),U()):(le(ke),re(),O())}function oe(e){return`${e&&typeof e=="object"&&e.id?String(e.id):String((e==null?void 0:e.type)||"task")}-${Date.now()}-${Math.random().toString(16).slice(2,8)}`}function Le(){return{title:C||b.title||"Generated Practice",level:I||b.level||"custom",tasks:[...N,...K].map(e=>e.data)}}function O(){if(D){if(ce()){q(Q);return}if(!N.length&&!K.length){D.textContent="",q(Q),L&&(L.disabled=!0),P&&(P.disabled=!0);return}D.textContent=JSON.stringify(Le(),null,2),le(Q),L&&(L.disabled=!1),P&&(P.disabled=!1)}}function gt(e){const t=oe(e);return K.push({key:t,data:e}),O(),t}function wt(e,t){const n=r=>{const a=r.findIndex(s=>e&&s.key===e||s.data===t);return a!==-1?(r.splice(a,1),!0):!1};(n(K)||n(N))&&O()}function Et(){if(!m)return;const e=m.querySelector('[name="topic"]');if(e&&!e.value){const t=b.title||"Lesson topic";e.value=t}}function x(e,t="idle"){V&&(V.textContent=e,V.dataset.state=t)}function bt(e){return String(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,8)}function X(e){return String(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function de(){return Array.from(m.querySelectorAll('input[name="types"]'))}function xt(e){const t=e.filter(n=>n.checked).map(n=>{var o,r;return(r=(o=n.nextElementSibling)==null?void 0:o.textContent)==null?void 0:r.trim()}).filter(Boolean);return t.length?t.length<=2?t.join(", "):`${t.slice(0,2).join(", ")} +${t.length-2}`:"Оберіть типи"}function re(){if(!S)return;const e=de();S.textContent=xt(e)}function U(){!M||!S||_e(M)||(q(M),S.setAttribute("aria-expanded","false"))}function St(){if(!M||!S)return;if(_e(M)){le(M),S.setAttribute("aria-expanded","true");const t=M.querySelector('input[name="types"]');t==null||t.focus({preventScroll:!0})}else U()}function Tt(){const e=!ce();localStorage.setItem("hideGenerateSection",String(e)),ne(),O()}function kt(){const e=document.getElementById("practice"),t=e==null?void 0:e.querySelector("#practice-body");if(ve&&ve.remove(),t&&t.children.length===1){const n=t.firstElementChild;n&&/практика поки відсутня/i.test(n.textContent||"")&&n.remove()}}function vt(){const e=document.getElementById("practice");if(!e)return;const t=e.querySelector("#practice-body");if(t&&!t.querySelector(".practice-dynamic-title")){const n=document.createElement("div");n.className="practice-dynamic-title",n.innerHTML=`
      <h2>Згенеровані завдання</h2>
      ${b.level?`<p class="muted">Рівень: ${b.level}</p>`:""}
    `,t.prepend(n)}}async function $t(e){var _,k;if(e.preventDefault(),!m)return;const t=m.querySelector('button[type="submit"]'),n=m.querySelector('[name="topic"]'),o=m.querySelector('[name="count"]'),r=m.querySelector('[name="instructions"]'),a=de(),s=(_=n==null?void 0:n.value)==null?void 0:_.trim(),i=Number.parseInt((o==null?void 0:o.value)||"10",10)||10,l=((k=r==null?void 0:r.value)==null?void 0:k.trim())||"",c=a.filter(u=>u.checked).map(u=>u.value);if(!s){x("Укажіть тему для генерації завдання.","error"),n==null||n.focus();return}if(!c.length&&typeof U=="function"){x("Оберіть принаймні один тип завдання.","error");return}const h=bt(s)||"task";x(`Генеруємо ${c.length} тип(и) завдань…`,"loading"),t&&(t.disabled=!0,t.dataset.originalText=t.dataset.originalText||t.textContent,t.textContent="Генерація…"),String(b.category||"").toLowerCase();const w=void 0;try{const u=c.map(g=>dt(s,g,{items:i,language:"en",seedId:`${h}-${g}`,...l?{additionalInstructions:l}:{}},w).then($=>({type:g,task:$}))),p=await Promise.allSettled(u),v=p.map((g,$)=>g.status==="fulfilled"?{type:c[$],task:g.value.task}:null).filter(Boolean),B=p.map((g,$)=>g.status==="rejected"?c[$]:null).filter(Boolean);if(!v.length)throw new Error("Не вдалося згенерувати жодного типу завдань");const j=[];v.forEach(({type:g,task:$})=>{const G={...$};G.id||(G.id=`${g}-${h}-${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`);const Pe=gt(G);j.push({task:G,key:Pe})}),kt(),window.practice&&typeof window.practice.appendTask=="function"&&(vt(),j.forEach(({task:g,key:$})=>{window.practice.appendTask(g,{key:$})})),U();const ue=v.map(({type:g})=>g).join(", ");B.length?x(`Згенеровано: ${ue}. Помилки: ${B.join(", ")}`,"success"):x(`Готово! Додано ${v.length} блок(и): ${ue}.`,"success")}catch(u){console.error(u);const p=u instanceof Error&&u.message?`Помилка: ${u.message}`:"Не вдалося згенерувати завдання. Перевірте токен або спробуйте ще раз.";x(p,"error")}finally{if(t){const u=t.dataset.originalText||"Згенерувати завдання";t.disabled=!1,t.textContent=u}}}async function Ct(){if(!D)return;const e=D.textContent;if(e)try{await navigator.clipboard.writeText(e),x("JSON скопійовано у буфер.","success")}catch(t){console.error(t),x("Не вдалося скопіювати JSON. Спробуйте вручну.","error")}}function It(e){return`${X(b.id)||X(e.title)||X(b.title)||"practice"||"practice"}.json`}async function Mt(){const e=Le(),t=JSON.stringify(e,null,2);if(!t||t==="{}"||t==="[]"){x("Немає даних для завантаження.","error");return}try{const n=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(n),r=document.createElement("a");r.href=o,r.download=It(e),document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(o),x("Файл завантажено.","success")}catch(n){console.error(n),x("Не вдалося завантажити файл.","error")}}function At(){if(m){if(Et(),m.addEventListener("submit",$t),L&&(L.addEventListener("click",Ct),L.disabled=!0),P&&(P.addEventListener("click",Mt),P.disabled=!0),S&&M&&W){S.setAttribute("aria-haspopup","true"),S.setAttribute("aria-expanded","false"),S.addEventListener("click",()=>{St()});const e=n=>{W.contains(n.target)||U()};document.addEventListener("pointerdown",e);const t=n=>{const o=n.relatedTarget;(!o||!W.contains(o))&&U()};W.addEventListener("focusout",t),document.addEventListener("keydown",n=>{n.key==="Escape"&&(U(),S.focus())}),de().forEach(n=>{n.addEventListener("change",()=>{re()})}),re(),m.addEventListener("submit",()=>{U()})}document.addEventListener("practice:taskRemoved",e=>{const t=e.detail||{};wt(t.key,t.task)}),document.addEventListener("practice:dataLoaded",e=>{const t=e.detail;N.length=0,t&&Array.isArray(t.entries)?(C=t.title??C,I=t.level??I,t.entries.forEach(({task:n,key:o})=>{const r=o||oe(n);N.push({key:r,data:n})})):t&&Array.isArray(t.tasks)?(C=t.title??C,I=t.level??I,t.tasks.forEach(n=>{const o=n&&n.id?String(n.id):oe(n);N.push({key:o,data:n})})):t?(C=t.title??C,I=t.level??I):(C=b.title||C,I=b.level||I),O(),ne()}),ne(),O(),document.addEventListener("keydown",e=>{e.code&&e.code==="KeyH"&&e.ctrlKey&&e.shiftKey&&(e.preventDefault(),Tt())})}}At();
