...
${l}`}:i}const xt={mcq:10,gap:10,transform:10,match:8,error:10,order:10,short:3,open:4,writing:1,roleplay:8,"dialogue-gap":6,"dialogue-order":6,truefalse:8,"definition-match":8,"synonym-clue":8,scramble:8,wordpairs:8,"odd-one-out":8,context:4};function f(e,t,n){return`Topic: ${e}
Generate a task block of type "${t}" with ${n} items. Return JSON only that follows the described schema.`}function kt(e){return String(e||"task").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,6)||"task"}function Et(e,t){const n=String(e||"").trim(),r=Tt(t);return r?`${n||"Generate the task block."}
...
Target vocabulary:
${r}`:n||e||""}function Tt(e){if(!Array.isArray(e)||!e.length)return"";const t=r=>{if(!r)return"";const a=r.indexOf(" — "),o=r.indexOf(" – "),s=r.indexOf(" - "),i=[a,o,s].filter(h=>h>=0),l=i.length?Math.min(...i):-1;return(l>=0?r.slice(0,l):r).trim()},n=e.map((r,a)=>{if(!r)return"";const o=r.word||r.term||r.phrase||r.text||`Item ${a+1}`,s=r.translation||r.meaning||r.ua||r.uk||"",i=r.example||r.sentence||r.usage||r.sample||"",l=t(i);let c=`${a+1}. ${o}`;return s&&(c+=` — ${s}`),l&&(c+=` (Example: ${l})`),c}).filter(Boolean);return n.length?n.join(`
`):""}const Ce=document.querySelector(".js-practice-section"),m=document.querySelector("[data-practice-generator]"),V=m==null?void 0:m.querySelector("[data-practice-status]"),F=document.querySelector("[data-generator-output]"),W=document.querySelector("[data-generator-json]"),P=document.querySelector("[data-generator-copy]"),_=document.querySelector("[data-generator-download]"),D=m==null?void 0:m.querySelector("[data-types]"),v=m==null?void 0:m.querySelector("[data-types-trigger]"),A=m==null?void 0:m.querySelector("[data-types-panel]"),$e=document.querySelector("[data-practice-placeholder]"),E=window.lessonContext||{};let $=E.title||"Generated Practice",M=E.level||"custom";const O=[],Q=[];function q(e){e&&e.classList.add("hidden")}function de(e){e&&e.classList.remove("hidden")}function Oe(e){return!e||e.classList.contains("hidden")}function pe(){return localStorage.getItem("hideGenerateSection")==="true"}function re(){pe()?(q(Ce),q(A),q(F),L()):(de(Ce),oe(),N())}function ae(e){return`${e&&typeof e=="object"&&e.id?String(e.id):String((e==null?void 0:e.type)||"task")}-${Date.now()}-${Math.random().toString(16).slice(2,8)}`}function qe(){return{title:$||E.title||"Generated Practice",level:M||E.level||"custom",tasks:[...O,...Q].map(e=>e.data)}}function N(){if(W){if(pe()){q(F);return}if(!O.length&&!Q.length){W.textContent="",q(F),P&&(P.disabled=!0),_&&(_.disabled=!0);return}W.textContent=JSON.stringify(qe(),null,2),de(F),P&&(P.disabled=!1),_&&(_.disabled=!1)}}function vt(e){const t=ae(e);return Q.push({key:t,data:e}),N(),t}function St(e,t){const n=a=>{const o=a.findIndex(s=>e&&s.key===e||s.data===t);return o!==-1?(a.splice(o,1),!0):!1};(n(Q)||n(O))&&N()}function It(){if(!m)return;const e=m.querySelector('[name="topic"]');if(e&&!e.value){const t=E.title||"Lesson topic";e.value=t}}function T(e,t="idle"){V&&(V.textContent=e,V.dataset.state=t)}function Ct(e){return String(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,8)}function X(e){return String(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function me(){return Array.from(m.querySelectorAll('input[name="types"]'))}function $t(e){const t=e.filter(n=>n.checked).map(n=>{var r,a;return(a=(r=n.nextElementSibling)==null?void 0:r.textContent)==null?void 0:a.trim()}).filter(Boolean);return t.length?t.length<=2?t.join(", "):`${t.slice(0,2).join(", ")} +${t.length-2}`:"Оберіть типи"}function oe(){if(!v)return;const e=me();v.textContent=$t(e)}function L(){!A||!v||Oe(A)||(q(A),v.setAttribute("aria-expanded","false"))}function Mt(){if(!A||!v)return;if(Oe(A)){de(A),v.setAttribute("aria-expanded","true");const t=A.querySelector('input[name="types"]');t==null||t.focus({preventScroll:!0})}else L()}function At(){const e=!pe();localStorage.setItem("hideGenerateSection",String(e)),re(),N()}function Ut(){const e=document.getElementById("practice"),t=e==null?void 0:e.querySelector("#practice-body");if($e&&$e.remove(),t&&t.children.length===1){const n=t.firstElementChild;n&&/практика поки відсутня/i.test(n.textContent||"")&&n.remove()}}function Lt(){const e=document.getElementById("practice");if(!e)return;const t=e.querySelector("#practice-body");if(t&&!t.querySelector(".practice-dynamic-title")){const n=document.createElement("div");n.className="practice-dynamic-title",n.innerHTML=`
      <h2>Згенеровані завдання</h2>
      ${E.level?`<p class="muted">Рівень: ${E.level}</p>`:""}
    `,t.prepend(n)}}async function Pt(e){var x,y;if(e.preventDefault(),!m)return;const t=m.querySelector('button[type="submit"]'),n=m.querySelector('[name="topic"]'),r=m.querySelector('[name="count"]'),a=m.querySelector('[name="instructions"]'),o=me(),s=(x=n==null?void 0:n.value)==null?void 0:x.trim(),i=Number.parseInt((r==null?void 0:r.value)||"10",10)||10,l=((y=a==null?void 0:a.value)==null?void 0:y.trim())||"",c=o.filter(d=>d.checked).map(d=>d.value);if(!s){T("Укажіть тему для генерації завдання.","error"),n==null||n.focus();return}if(!c.length&&typeof L=="function"){T("Оберіть принаймні один тип завдання.","error");return}const h=Ct(s)||"task";T(`Генеруємо ${c.length} тип(и) завдань…`,"loading"),t&&(t.disabled=!0,t.dataset.originalText=t.dataset.originalText||t.textContent,t.textContent="Генерація…"),String(E.category||"").toLowerCase();const b=void 0;try{const d=c.map(g=>yt(s,g,{items:i,language:"en",seedId:`${h}-${g}`,...l?{additionalInstructions:l}:{}},b).then(C=>({type:g,task:C}))),u=await Promise.allSettled(d),I=u.map((g,C)=>g.status==="fulfilled"?{type:c[C],task:g.value.task}:null).filter(Boolean),j=u.map((g,C)=>g.status==="rejected"?c[C]:null).filter(Boolean);if(!I.length)throw new Error("Не вдалося згенерувати жодного типу завдань");const z=[];I.forEach(({type:g,task:C})=>{const B={...C};B.id||(B.id=`${g}-${h}-${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`);const Ne=vt(B);z.push({task:B,key:Ne})}),Ut(),window.practice&&typeof window.practice.appendTask=="function"&&(Lt(),z.forEach(({task:g,key:C})=>{window.practice.appendTask(g,{key:C})})),L();const ue=I.map(({type:g})=>g).join(", ");j.length?T(`Згенеровано: ${ue}. Помилки: ${j.join(", ")}`,"success"):T(`Готово! Додано ${I.length} блок(и): ${ue}.`,"success")}catch(d){console.error(d);const u=d instanceof Error&&d.message?`Помилка: ${d.message}`:"Не вдалося згенерувати завдання. Перевірте токен або спробуйте ще раз.";T(u,"error")}finally{if(t){const d=t.dataset.originalText||"Згенерувати завдання";t.disabled=!1,t.textContent=d}}}async function _t(){if(!W)return;const e=W.textContent;if(e)try{await navigator.clipboard.writeText(e),T("JSON скопійовано у буфер.","success")}catch(t){console.error(t),T("Не вдалося скопіювати JSON. Спробуйте вручну.","error")}}function Ot(e){return`${X(E.id)||X(e.title)||X(E.title)||"practice"||"practice"}.json`}async function qt(){const e=qe(),t=JSON.stringify(e,null,2);if(!t||t==="{}"||t==="[]"){T("Немає даних для завантаження.","error");return}try{const n=new Blob([t],{type:"application/json"}),r=URL.createObjectURL(n),a=document.createElement("a");a.href=r,a.download=Ot(e),document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(r),T("Файл завантажено.","success")}catch(n){console.error(n),T("Не вдалося завантажити файл.","error")}}function Nt(){if(m){if(It(),m.addEventListener("submit",Pt),P&&(P.addEventListener("click",_t),P.disabled=!0),_&&(_.addEventListener("click",qt),_.disabled=!0),v&&A&&D){v.setAttribute("aria-haspopup","true"),v.setAttribute("aria-expanded","false"),v.addEventListener("click",()=>{Mt()});const e=n=>{D.contains(n.target)||L()};document.addEventListener("pointerdown",e);const t=n=>{const r=n.relatedTarget;(!r||!D.contains(r))&&L()};D.addEventListener("focusout",t),document.addEventListener("keydown",n=>{n.key==="Escape"&&(L(),v.focus())}),me().forEach(n=>{n.addEventListener("change",()=>{oe()})}),oe(),m.addEventListener("submit",()=>{L()})}document.addEventListener("practice:taskRemoved",e=>{const t=e.detail||{};St(t.key,t.task)}),document.addEventListener("practice:dataLoaded",e=>{const t=e.detail;O.length=0,t&&Array.isArray(t.entries)?($=t.title??$,M=t.level??M,t.entries.forEach(({task:n,key:r})=>{const a=r||ae(n);O.push({key:a,data:n})})):t&&Array.isArray(t.tasks)?($=t.title??$,M=t.level??M,t.tasks.forEach(n=>{const r=n&&n.id?String(n.id):ae(n);O.push({key:r,data:n})})):t?($=t.title??$,M=t.level??M):($=E.title||$,M=E.level||M),N(),re()}),re(),N(),document.addEventListener("keydown",e=>{e.code&&e.code==="KeyH"&&e.ctrlKey&&e.shiftKey&&(e.preventDefault(),At())})}}Nt();
