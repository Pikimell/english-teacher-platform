import"./assets/main-Ci6GKLq-.js";import{s as Re,d as He,e as je,i as Be,f as De}from"./assets/practice-604QvU9W.js";import{l as se,a as We,b as ie}from"./assets/custom-lessons-store-ClPKfKWc.js";import{a as he,c as fe}from"./assets/auth-Y9Je3ray.js";import"./assets/vendor-CWxt7QI6.js";const le={"greetings-farewells":[{word:"Hello",translation:"Привіт",example:"Hello, nice to meet you!"},{word:"Hi",translation:"Привіт (неформально)",example:"Hi, are you ready for class?"},{word:"Good morning",translation:"Доброго ранку",example:"Good morning, Mrs Smith."},{word:"Good afternoon",translation:"Доброго дня",example:"Good afternoon, everyone."},{word:"Good evening",translation:"Доброго вечора",example:"Good evening, how was your day?"},{word:"Nice to meet you",translation:"Приємно познайомитися",example:"Nice to meet you, I'm Tom."},{word:"How are you?",translation:"Як справи?",example:"Hi, Anna! How are you?"},{word:"I'm fine, thanks",translation:"У мене все добре, дякую",example:"I'm fine, thanks. And you?"},{word:"See you later",translation:"Побачимось пізніше",example:"I have to go now. See you later!"},{word:"See you soon",translation:"До скорої зустрічі",example:"Thanks for your help. See you soon."},{word:"Goodbye",translation:"До побачення",example:"Goodbye, have a nice evening!"},{word:"Bye",translation:"Бувай",example:"Bye, talk to you tomorrow!"},{word:"Take care",translation:"Бережи себе",example:"I'm heading home now. Take care!"},{word:"Have a nice day",translation:"Гарного дня",example:"Thanks for coming. Have a nice day!"},{word:"Good night",translation:"Надобраніч",example:"It's late. Good night!"}],"personal-info-basics":[{word:"first name",translation:"ім'я",example:"My first name is Olha."},{word:"last name",translation:"прізвище",example:"Her last name is Petrenko."},{word:"full name",translation:"повне ім'я",example:"Please write your full name here."},{word:"nickname",translation:"прізвисько / нікнейм",example:"His friends call him Max; it's his nickname."},{word:"age",translation:"вік",example:"My age is twenty."},{word:"I am ... years old",translation:"мені ... років",example:"I am twenty years old."},{word:"years old",translation:"років (вік)",example:"I'm eleven years old."},{word:"country",translation:"країна",example:"My country is Ukraine."},{word:"city",translation:"місто",example:"I live in the city of Lviv."},{word:"hometown",translation:"рідне місто",example:"My hometown is Poltava."},{word:"place of birth",translation:"місце народження",example:"My place of birth is Kharkiv."},{word:"address",translation:"адреса",example:"My address is 12 Green Street."},{word:"nationality",translation:"національність",example:"She is Italian by nationality."},{word:"native language",translation:"рідна мова",example:"Ukrainian is my native language."},{word:"foreign language",translation:"іноземна мова",example:"English is my first foreign language."},{word:"from",translation:"з / родом із",example:"I am from Ukraine."},{word:"live in",translation:"жити в",example:"I live in Kyiv."},{word:"live with",translation:"жити з",example:"I live with my parents."},{word:"date of birth",translation:"дата народження",example:"My date of birth is May 12, 2005."},{word:"job / occupation",translation:"робота / професія",example:"My job is a student."},{word:"student",translation:"студент / учень",example:"I'm a student at the local school."},{word:"teacher",translation:"вчитель / викладач",example:"My teacher is from Canada."},{word:"grade",translation:"клас (у школі)",example:"I'm in Grade 6."},{word:"single",translation:"неодружений / неодружена",example:"He is single at the moment."},{word:"married",translation:"одружений / заміжня",example:"My parents are married."},{word:"male",translation:"чоловіча стать",example:"He is male."},{word:"female",translation:"жіноча стать",example:"She is female."},{word:"speak",translation:"говорити (мовою)",example:"I speak Ukrainian and English."},{word:"introduce yourself",translation:"представитись",example:"Let me introduce myself."}],"classroom-objects":[{word:"pen",translation:"ручка",transcription:"pen",example:"I write with a blue pen."},{word:"pencil",translation:"олівець",transcription:"ˈpensl",example:"This pencil is very sharp."},{word:"notebook",translation:"зошит",transcription:"ˈnəʊtbʊk",example:"I have a new notebook for English."},{word:"eraser",translation:"гумка",transcription:"ɪˈreɪzə",example:"Use an eraser to correct mistakes."},{word:"ruler",translation:"лінійка",transcription:"ˈruːlə",example:"The ruler is on the desk."},{word:"desk",translation:"парта, робочий стіл",transcription:"desk",example:"My desk is next to the window."},{word:"chair",translation:"стілець",transcription:"tʃeə",example:"There is a chair in front of the desk."},{word:"computer",translation:"комп’ютер",transcription:"kəmˈpjuːtə",example:"I work on the computer every day."},{word:"keyboard",translation:"клавіатура",transcription:"ˈkiːbɔːd",example:"Type your name on the keyboard."},{word:"mouse",translation:"мишка (комп’ютерна)",transcription:"maʊs",example:"Click the mouse to open the file."},{word:"book",translation:"книга",transcription:"bʊk",example:"Open your book at page ten."},{word:"paper",translation:"папір",transcription:"ˈpeɪpə",example:"I need a piece of paper."},{word:"folder",translation:"папка",transcription:"ˈfəʊldə",example:"Put your documents in the folder."},{word:"document",translation:"документ",transcription:"ˈdɒkjʊmənt",example:"I printed the document for the meeting."},{word:"printer",translation:"принтер",transcription:"ˈprɪntə",example:"The printer is not working today."},{word:"board",translation:"дошка",transcription:"bɔːd",example:"The teacher writes on the board."},{word:"marker",translation:"маркер",transcription:"ˈmɑːkə",example:"Use a black marker, please."},{word:"bag",translation:"сумка, рюкзак",transcription:"bæɡ",example:"My school bag is very heavy."},{word:"calendar",translation:"календар",transcription:"ˈkælɪndə",example:"The calendar is on the wall."},{word:"lamp",translation:"лампа",transcription:"læmp",example:"The lamp is on the desk."},{word:"stapler",translation:"степлер",transcription:"ˈsteɪplə",example:"Can I use your stapler?"},{word:"paper clip",translation:"скріпка",transcription:"ˈpeɪpə klɪp",example:"There are some paper clips in the drawer."},{word:"envelope",translation:"конверт",transcription:"ˈenvələʊp",example:"Put the letter in an envelope."},{word:"whiteboard",translation:"біла дошка",transcription:"ˈwaɪtbɔːd",example:"The whiteboard is clean now."},{word:"clock",translation:"годинник",transcription:"klɒk",example:"There is a clock on the wall."}],"colours-basics":[{word:"black",translation:"чорний",transcription:"blæk",example:"I prefer a black theme in the app."},{word:"white",translation:"білий",transcription:"waɪt",example:"The logo looks clean on a white background."},{word:"grey",translation:"сірий",transcription:"ɡreɪ",example:"Use a light grey for the captions."},{word:"gray",translation:"сірий (амер.)",transcription:"ɡreɪ",example:"The walls are painted gray."},{word:"red",translation:"червоний",transcription:"red",example:"Red buttons usually signal an alert."},{word:"blue",translation:"синій",transcription:"bluː",example:"Our brand uses a dark blue palette."},{word:"green",translation:"зелений",transcription:"ɡriːn",example:"Green indicates success or confirmation."},{word:"yellow",translation:"жовтий",transcription:"ˈjel.oʊ",example:"Add a yellow highlight for emphasis."},{word:"orange",translation:"помаранчевий",transcription:"ˈɒr.ɪndʒ",example:"Orange can draw attention to a CTA."},{word:"purple",translation:"фіолетовий",transcription:"ˈpɜː.pəl",example:"We tested a purple accent on the header."},{word:"pink",translation:"рожевий",transcription:"pɪŋk",example:"This chart uses pink for the second series."},{word:"brown",translation:"коричневий",transcription:"braʊn",example:"We switched to a warm brown for the furniture."},{word:"beige",translation:"бежевий",transcription:"beɪʒ",example:"Beige walls make the room calmer."},{word:"light",translation:"світлий",transcription:"laɪt",example:"Use a light green header."},{word:"dark",translation:"темний",transcription:"dɑːk",example:"A dark blue footer looks more balanced."},{word:"pale",translation:"блідий",transcription:"peɪl",example:"Pale pink is used for the background."},{word:"pastel",translation:"пастельний",transcription:"ˈpæs.təl",example:"I like pastel colours for minimalistic design."},{word:"bright",translation:"яскравий",transcription:"braɪt",example:"Bright yellow icons catch the eye."},{word:"vivid",translation:"насичений",transcription:"ˈvɪv.ɪd",example:"Use a vivid red to emphasize urgency."},{word:"deep",translation:"глибокий (про колір)",transcription:"diːp",example:"I prefer a deep purple accent."},{word:"rich",translation:"багатий, насичений",transcription:"rɪtʃ",example:"The brand uses a rich green tone."},{word:"neutral",translation:"нейтральний",transcription:"ˈnjuː.trəl",example:"Neutral grey works well for typography."},{word:"muted",translation:"приглушений",transcription:"ˈmjuː.tɪd",example:"Use a muted orange instead of a bright one."},{word:"warm",translation:"теплий (відтінок)",transcription:"wɔːm",example:"Warm beige creates a cozy atmosphere."},{word:"cool",translation:"холодний (відтінок)",transcription:"kuːl",example:"Cool blue feels more professional."},{word:"contrast",translation:"контраст",transcription:"ˈkɒn.trɑːst",example:"Increase the contrast for better readability."},{word:"shade",translation:"відтінок",transcription:"ʃeɪd",example:"Choose a lighter shade of green."},{word:"tone",translation:"тон",transcription:"təʊn",example:"The tone of blue is too dark."},{word:"palette",translation:"палітра",transcription:"ˈpæl.ət",example:"Our new brand palette includes three main colours."}]},K=new Map;let ye=!1;function ze(){ye||(ye=!0,he.subscribe(({user:e})=>{Re(he.isAdmin(e))}))}function Ge(e){if(!e)return;const t=window.getComputedStyle(e).position;(t==="static"||!t)&&(e.style.position="relative")}function Fe(e){const t=e.querySelector(".lesson-topic__share-controls");if(t)return t;const n=document.createElement("div");return n.className="lesson-topic__share-controls",n.style.position="absolute",n.style.top="0",n.style.right="0",n.style.display="flex",n.style.gap="6px",n.style.alignItems="center",n.style.zIndex="10",e.appendChild(n),n}function Ke(e){if(!e||K.has(e))return;const t=e.querySelector(".lesson-topic__header")??e;Ge(t);const n=Fe(t),{button:o,panel:r,unregister:a}=He({context:e,triggerClassName:"lesson-topic__share-trigger for-admin js-share-topic-btn",triggerStyle:"border:none;background:#2563eb;color:#fff;padding:4px 12px;border-radius:999px;font-size:12px;line-height:1;cursor:pointer;box-shadow:0 4px 12px rgba(37,99,235,0.24);",onShare:({student:i,context:s})=>{const l=document.createElement("div");l.innerHTML=s.outerHTML;const c=window.location.search.slice(8),h=document.querySelector("h1"),g=h?h.textContent:"",v=l.querySelector(".lesson-topic__share-controls"),E=l.querySelector(".practice-share-panel");v.remove(),E.remove();const d={lessonId:c,userEmail:i.email,lessonName:g,homeworkType:"theory",homeworkData:l.innerHTML};return je(d)}});r.style.right="0",r.style.top="38px",n.appendChild(o),t.appendChild(r),K.set(e,{unregister:a,panel:r})}function Qe(){K.forEach((e,t)=>{var n;t.isConnected||(e.panel&&Be(e.panel)&&De(),(n=e.unregister)==null||n.call(e),K.delete(t))})}const we=()=>{ze(),Qe(),document.querySelectorAll(".lesson-topic").forEach(t=>Ke(t))},Je=55,Ye=5,Me=0,Ve={"custom-no1-mggxs7zo":[{id:"abf91e0d2ea04f8cabb896481369bcdf",themeId:"42",templateId:"70",fontStackId:Me,title:"Wordwall вправа"}],"custom-no2-4db25661":[{id:"110f5ab8bba8415eadefd09fb52c4e87",themeId:"65",templateId:"30",fontStackId:"12",title:"Wordwall вправа для особових займенників",url:"https://wordwall.net/embed/110f5ab8bba8415eadefd09fb52c4e87?themeId=65&templateId=30&fontStackId=12"}],"custom-no3-b9fd7e6c":[{id:"110f5ab8bba8415eadefd09fb52c4e87",themeId:"65",templateId:"30",fontStackId:"12",title:"Wordwall вправа для особових займенників",url:"https://wordwall.net/embed/110f5ab8bba8415eadefd09fb52c4e87?themeId=65&templateId=30&fontStackId=12"}],"custom-no4-c6f6abec":[{id:"110f5ab8bba8415eadefd09fb52c4e87",themeId:"65",templateId:"30",fontStackId:"12",title:"Wordwall вправа для особових займенників",url:"https://wordwall.net/embed/110f5ab8bba8415eadefd09fb52c4e87?themeId=65&templateId=30&fontStackId=12"}],"custom-no5-a3c6ccb2":[{id:"cd69f6a25d164b098c91cb9f50c307ee",themeId:"65",templateId:"30",fontStackId:"12",title:"Wordwall вправа для особових займенників",url:"https://wordwall.net/embed/cd69f6a25d164b098c91cb9f50c307ee?themeId=65&templateId=30&fontStackId=0"}],"custom-no6-da70b690":[],"custom-no7-43000f0c":[],"custom-no8-846a8d9e":[],"custom-no9-cf6e6bee":[],"custom-no10-28500f64":[],"custom-no11-d8d86e31":[],"custom-no12-93e53fe8":[],"custom-no13-f4bcb910":[],"custom-no14-40fdaa86":[],"custom-no15-ef51a27e":[],"custom-no16-e3b3d783":[],"custom-no17-6337b1c4":[],"custom-no18-b8435532":[],"custom-no19-8d87b15e":[],"custom-no20-06a86866":[],"custom-no21-670eb82c":[],"custom-no22-2073a55b":[],"custom-no23-21e7300b":[],"custom-no24-29c54cf7":[],"custom-no25-796a6730":[],"custom-no26-9b5f1ffc":[],"custom-no27-6487572a":[],"custom-no28-7f7a2815":[],"custom-no29-9710e19a":[],"custom-no30-b72e7840":[],"custom-no31-2b6f7bda":[],"custom-no32-deb561b3":[],"custom-no33-9a2f527a":[],"custom-no34-5b2c8e22":[],"custom-no35-a6a8ac33":[],"custom-no36-6a082f08":[],"custom-no37-faa9b7b8":[],"custom-no38-5206027c":[],"custom-no39-6b35cfd3":[],"custom-no40-4927837a":[],"custom-no41-7ba1db93":[],"custom-no42-29b5bb10":[],"custom-no43-7ecfedc0":[],"custom-no44-0e8b8ebd":[],"custom-no45-310fbeb4":[],"custom-no46-ccb1de5a":[],"custom-no47-d6148758":[],"custom-no48-3e5720c9":[],"custom-no49-f759cafd":[],"custom-no50-23930ae8":[]};function Xe(e){return e?e.url?String(e.url):e.id?`https://wordwall.net/embed/${String(e.id).trim()}`:null:null}function Ae(e){const t=Xe(e);if(!t)return null;const n=new URLSearchParams,o=e.themeId??Je,r=e.templateId??Ye,a=e.fontStackId??Me;o!=null&&n.set("themeId",String(o)),r!=null&&n.set("templateId",String(r)),a!=null&&n.set("fontStackId",String(a));const i=n.toString();return i?`${t}?${i}`:t}function Ze(e){const t=Ae(e);if(!t)return null;const n=document.createElement("iframe");return n.className="lesson-wordwall__iframe",n.src=t,n.width=String(e.width??1e3),n.height=String(e.height??760),n.setAttribute("frameborder","0"),n.setAttribute("allowfullscreen","true"),n.setAttribute("loading","lazy"),n.setAttribute("referrerpolicy","strict-origin-when-cross-origin"),e.title&&n.setAttribute("title",e.title),n}function et(e){if(!e)return[];const t=Ve[e];return Array.isArray(t)?t.map(n=>({...n})).filter(n=>!!Ae(n)):[]}const tt={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1},J=typeof import.meta<"u"&&tt&&"/"||"/";function ce(e){const t=J.endsWith("/")?J:`${J}/`,n=String(e||"");return n.startsWith(t)?n:`${t}${n.replace(/^\/+/,"")}`}const R=new URLSearchParams(window.location.search),nt=e=>e,H=R.get("topic"),ge=R.get("custom"),be=R.get("title"),xe=nt(R.get("category")),Ee=R.get("level"),ke=R.get("file"),m=H?se.find(e=>e.id===H):void 0,y=(()=>{if(!ge)return null;const e=[];return Array.isArray(fe)&&fe.forEach(t=>{if(!t||typeof t!="object")return;const n=Array.isArray(t.topicIds)?[...t.topicIds]:[];!t.id||!n.length||e.push({...t,topicIds:n,source:"preset"})}),We().filter(t=>t&&typeof t=="object").forEach(t=>{const n=Array.isArray(t.topicIds)?[...t.topicIds]:[];!t.id||!n.length||e.push({...t,topicIds:n,source:"local"})}),e.find(t=>t.id===ge)??null})(),T=!!y,G=T?y.title:m!=null&&m.title?m.title:be?decodeURIComponent(be):"Матеріал уроку",Z=T?"custom":m!=null&&m.category?m.category:xe?decodeURIComponent(xe):"",ee=(()=>{if(T){if(y.level)return y.level;const e=(y.topicIds||[]).map(n=>se.find(o=>o.id===n)).filter(Boolean);return Array.from(new Set(e.map(n=>n.level))).sort().join(", ")}return m!=null&&m.level?m.level:Ee?decodeURIComponent(Ee):""})(),te=(()=>{if(T)return null;const e=(m==null?void 0:m.htmlPath)??(ke?decodeURIComponent(ke):null);return e&&e.startsWith("lessons/")?e:null})();window.lessonContext={id:T?y.id:(m==null?void 0:m.id)??H??null,title:G,category:Z,level:ee,htmlPath:te,source:T?y.source||"custom":"catalog",topicIds:T?[...y.topicIds||[]]:m!=null&&m.id?[m.id]:H?[H]:[],isCustomLesson:T};const Se=document.querySelector("[data-lesson-title]"),Te=document.querySelector("[data-lesson-category]"),ve=document.querySelector("[data-lesson-level]"),U=document.querySelector("[data-lesson-status]"),b=document.getElementById("lesson-content");function ot(){const e=document.querySelector('[data-component="copyright-year"]');e&&(e.textContent=String(new Date().getFullYear()))}function rt(){Se&&(Se.textContent=G);const t=(()=>{var o;return T?"Комбінований урок":((o=ie[Z])==null?void 0:o.label)??""})()||Z;Te&&(Te.textContent=t||""),ve&&(ve.textContent=ee?`Рівень: ${ee}`:"");const n=document.getElementById("practice-title");n&&(n.textContent=G),document.title=`${G} | English Teacher Platform`}function Ue(e){return`lesson-topic-${String(e||"").trim().toLowerCase().replace(/[^a-z0-9_-]+/g,"-").replace(/^-+|-+$/g,"")||"topic"}`}function at(e){if(!e.length)return null;const t=document.createElement("section");t.className="lesson-custom-summary";const n=document.createElement("h2");n.textContent="Склад уроку",t.appendChild(n);const o=document.createElement("ol");return o.className="lesson-custom-summary__list",e.forEach((r,a)=>{var v;const i=document.createElement("li");i.className="lesson-custom-summary__item";const s=((v=ie[r.category])==null?void 0:v.label)??r.category,l=Ue(r.id),c=document.createElement("a");c.className="lesson-custom-summary__link",c.href=`#${l}`,c.dataset.topicAnchor=l;const h=document.createElement("strong");h.textContent=`${a+1}. ${r.title}`;const g=document.createElement("span");g.textContent=`${s} · ${r.level}`,c.appendChild(h),c.appendChild(g),c.addEventListener("click",E=>{const d=document.getElementById(l);d&&(E.preventDefault(),d.scrollIntoView({behavior:"smooth",block:"start"}),requestAnimationFrame(()=>{try{d.focus({preventScroll:!0})}catch{d.focus()}}))}),i.appendChild(c),o.appendChild(i)}),t.appendChild(o),t}async function st(e){if(!e)return null;const t=new Set;if(e.id&&t.add(`data/practice/${e.id}.json`),e.htmlPath){const n=String(e.htmlPath).replace(/^\.?\/?/,"").replace(/\.html?$/i,"");if(n){t.add(`data/practice/${n}.json`);const o=n.split("/"),r=o[o.length-1];r&&t.add(`data/practice/${r}.json`)}}for(const n of t)try{const o=await fetch(ce(n),{cache:"no-store"});if(!o.ok)continue;const r=await o.json();if(r&&Array.isArray(r.tasks)&&r.tasks.length)return r}catch(o){console.warn(`Не вдалося завантажити практику за шляхом ${n}`,o)}return null}function Y(e){if(!e)return;const t=document.createElement("p");t.className="practice-inline__empty muted",t.textContent="Практика для цієї теми поки відсутня.",e.appendChild(t)}function _e(e){const t=et(e);if(!t.length)return null;const n=document.createElement("section");n.className="lesson-wordwall";const o=document.createElement("h2");o.className="lesson-wordwall__title",o.textContent="Wordwall",n.appendChild(o);const r=document.createElement("div");r.className="lesson-wordwall__items",n.appendChild(r);let a=!1;return t.forEach((i,s)=>{const l=Ze({...i,title:i.title||`Wordwall вправа ${s+1}`});l&&(a=!0,r.appendChild(l))}),a?n:null}async function it(){var a;if(!b)return;const e=((y==null?void 0:y.topicIds)||[]).map(i=>se.find(s=>s.id===i)).filter(Boolean);if(!e.length){U&&(U.textContent="Не вдалося знайти вибрані теми. Створіть урок заново.");return}if(b.innerHTML="",y!=null&&y.description){const i=document.createElement("p");i.className="lesson-custom-description",i.textContent=y.description,b.appendChild(i)}const t={grammar:0,lexical:1},n=e.slice().sort((i,s)=>{const l=t[i.category]??99,c=t[s.category]??99;return l!==c?l-c:0}),o=at(n);o&&b.appendChild(o);const r=_e((y==null?void 0:y.id)??null);r&&b.appendChild(r);for(const i of n){const s=document.createElement("section");s.className="lesson-topic",s.dataset.topicId=i.id;const l=Ue(i.id);s.id=l,s.setAttribute("tabindex","-1");const c=document.createElement("header");c.className="lesson-topic__header";const h=document.createElement("h3");h.className="lesson-topic__title",h.textContent=i.title,c.appendChild(h);const g=document.createElement("p");g.className="lesson-topic__meta";const v=((a=ie[i.category])==null?void 0:a.label)??i.category;g.textContent=`${v} · Рівень ${i.level}`,c.appendChild(g),s.appendChild(c);const E=document.createElement("div");E.className="lesson-topic__body",s.appendChild(E),b.appendChild(s);try{const p=await fetch(ce(i.htmlPath));if(!p.ok)throw new Error(`Не вдалося завантажити файл: ${p.status}`);const C=await p.text();E.innerHTML=C}catch(p){E.innerHTML='<p class="lesson-topic__error">Не вдалося завантажити матеріал цієї теми.</p>',console.error(p)}const d=document.createElement("div");d.className="lesson-topic__practice",s.appendChild(d);try{const p=await st(i);if(p&&Array.isArray(p.tasks)&&p.tasks.length){const C=window.practice||{},B=p.title?`Практика: ${p.title}`:`Практика: ${i.title}`,D=p.level||i.level||"";typeof C.renderTaskList=="function"?C.renderTaskList(d,p.tasks,{title:B,level:D,description:p.description,keyPrefix:`${i.id}-practice`}):Y(d)}else Y(d)}catch(p){console.error("Помилка під час завантаження практики",p),Y(d)}}U&&U.remove(),await Pe(b)}async function lt(){if(b){if(T){await it(),we();return}if(!te){U&&(U.textContent="Не вдалося визначити файл з матеріалом. Перейдіть назад та оберіть тему зі списку.");return}try{const e=await fetch(ce(te));if(!e.ok)throw new Error(`Не вдалося завантажити файл: ${e.status}`);const t=await e.text();b.innerHTML="";const n=_e((m==null?void 0:m.id)??null);n&&b.appendChild(n);const o=document.createElement("template");o.innerHTML=t,b.appendChild(o.content),we(),await Pe(b)}catch(e){U&&(U.textContent="Сталася помилка під час завантаження матеріалу. Спробуйте пізніше або поверніться до каталогу."),console.error(e)}}}function Le(e){return String(e||"").trim().toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}const ne=Object.keys(le||{}).map(t=>({key:t,normalized:Le(t)})),Ce=(()=>{const e=new Map;return ne.forEach(t=>{t.normalized&&!e.has(t.normalized)&&e.set(t.normalized,t.key)}),e})();function ct(e){if(typeof e!="string")return null;const t=Object.prototype.hasOwnProperty.call(le,e)?e:null;if(t)return t;const n=Le(e);if(!n)return null;if(Ce.has(n))return Ce.get(n);const o=ne.find(a=>a.normalized.includes(n));if(o)return o.key;const r=ne.find(a=>n.includes(a.normalized));return r?r.key:null}function dt(e){if(!e)return null;const t=[],n=s=>{if(!s)return;const l=String(s).trim();l&&t.push(l)},o=["communicationTopic","topic","topicId","module","communicationModule"];o.forEach(s=>{var l;(l=e.dataset)!=null&&l[s]&&n(e.dataset[s])});const r=e.closest("[data-communication-topic],[data-topic],[data-topic-id],[data-module],[data-communication-module]");r&&r!==e&&o.forEach(s=>{var l;(l=r.dataset)!=null&&l[s]&&n(r.dataset[s])}),e.id&&n(e.id);const a=window.lessonContext||{};n(a.id),n(a.topicId),Array.isArray(a.topicIds)&&a.topicIds.forEach(n);const i=new Set;for(const s of t){if(i.has(s))continue;i.add(s);const l=ct(s);if(l)return l}return null}function mt(e,t){if(!e)return;const n=Array.isArray(t)?t:[];if(!n.length)return;e.classList.add("communication__table");const o=document.createElement("table"),r=document.createElement("thead"),a=document.createElement("tr");["Слово","Переклад","Приклад"].forEach(s=>{const l=document.createElement("th");l.textContent=s,a.appendChild(l)}),r.appendChild(a);const i=document.createElement("tbody");n.forEach(s=>{if(!s)return;const l=document.createElement("tr"),c=document.createElement("td");c.textContent=s.word||s.term||"";const h=document.createElement("td");h.textContent=s.translation||s.meaning||"";const g=document.createElement("td");g.textContent=s.example||s.sentence||"",l.appendChild(c),l.appendChild(h),l.appendChild(g),i.appendChild(l)}),o.appendChild(r),o.appendChild(i),e.innerHTML="",e.appendChild(o)}async function Pe(e){if(!e)return;const t=Array.from(e.querySelectorAll("[data-communication-words]"));t.length&&t.forEach(n=>{const o=dt(n);if(!o)return;const r=le[o]||[];r.length&&mt(n,r)})}function ut(){ot(),rt(),lt()}ut();const pt=async e=>{const n="https://vq1wtq2d2l.execute-api.us-east-2.amazonaws.com/dev"+"/openai";return await fetch(n,{method:"POST",body:JSON.stringify(e),headers:{"Content-Type":"application/json"}}).then(r=>r.json())},ht=async(e,t,n={},o=[])=>{const r=ft(e,t,n,o),a=await pt(r);try{return typeof a=="string"?JSON.parse(a):a}catch{const s=typeof a=="string"?a.match(/\{[\s\S]*\}$/):null;if(s)return JSON.parse(s[0]);throw new Error("Не вдалося розпарсити JSON відповіді моделі")}};function ft(e,t,n={},o=[]){const r=localStorage.getItem("gptToken");if(!r||(r==null?void 0:r.length)<10){console.warn("⚠️ gptToken відсутній у localStorage");const h=prompt("Enter Your GPT Token");localStorage.setItem("gptToken",h)}const a="gpt-4o-mini",i=String(t||"").trim().toLowerCase(),{system:s,user:l}=yt(e,i,n),c=bt(l,o);return{token:r,model:a,messages:[{role:"system",content:s},{role:"user",content:c}],temperature:.3,max_tokens:4e3}}function yt(e,t,n){n.language;const o=Number.isInteger(n.items)?n.items:wt[t]||10,r=n.seedId||gt(e),a=`
...
}`.trim(),user:f(e,"context",o)}},s=i[t]||i.mcq,l=(n.additionalInstructions||n.extraInstructions||"").trim();return l?{system:s.system,user:`${s.user}

Additional teacher instructions:
${l}`}:s}const wt={mcq:10,gap:10,transform:10,match:8,error:10,order:10,short:3,open:4,writing:1,roleplay:8,"dialogue-gap":6,"dialogue-order":6,truefalse:8,"definition-match":8,"synonym-clue":8,scramble:8,wordpairs:8,"odd-one-out":8,context:4};function f(e,t,n){return`Topic: ${e}
Generate a task block of type "${t}" with ${n} items. Return JSON only that follows the described schema.`}function gt(e){return String(e||"task").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,6)||"task"}function bt(e,t){const n=String(e||"").trim(),o=xt(t);return o?`${n||"Generate the task block."}
...
Target vocabulary:
${o}`:n||e||""}function xt(e){if(!Array.isArray(e)||!e.length)return"";const t=o=>{if(!o)return"";const r=o.indexOf(" — "),a=o.indexOf(" – "),i=o.indexOf(" - "),s=[r,a,i].filter(h=>h>=0),l=s.length?Math.min(...s):-1;return(l>=0?o.slice(0,l):o).trim()},n=e.map((o,r)=>{if(!o)return"";const a=o.word||o.term||o.phrase||o.text||`Item ${r+1}`,i=o.translation||o.meaning||o.ua||o.uk||"",s=o.example||o.sentence||o.usage||o.sample||"",l=t(s);let c=`${r+1}. ${a}`;return i&&(c+=` — ${i}`),l&&(c+=` (Example: ${l})`),c}).filter(Boolean);return n.length?n.join(`
`):""}const Ie=document.querySelector(".js-practice-section"),u=document.querySelector("[data-practice-generator]"),V=u==null?void 0:u.querySelector("[data-practice-status]"),F=document.querySelector("[data-generator-output]"),j=document.querySelector("[data-generator-json]"),L=document.querySelector("[data-generator-copy]"),P=document.querySelector("[data-generator-download]"),z=u==null?void 0:u.querySelector("[data-types]"),S=u==null?void 0:u.querySelector("[data-types-trigger]"),A=u==null?void 0:u.querySelector("[data-types-panel]"),$e=document.querySelector("[data-practice-placeholder]"),x=window.lessonContext||{};let $=x.title||"Generated Practice",M=x.level||"custom";const O=[],Q=[];function N(e){e&&e.classList.add("hidden")}function de(e){e&&e.classList.remove("hidden")}function Oe(e){return!e||e.classList.contains("hidden")}function me(){return localStorage.getItem("hideGenerateSection")==="true"}function oe(){me()?(N(Ie),N(A),N(F),_()):(de(Ie),ae(),q())}function re(e){return`${e&&typeof e=="object"&&e.id?String(e.id):String((e==null?void 0:e.type)||"task")}-${Date.now()}-${Math.random().toString(16).slice(2,8)}`}function Ne(){return{title:$||x.title||"Generated Practice",level:M||x.level||"custom",tasks:[...O,...Q].map(e=>e.data)}}function q(){if(j){if(me()){N(F);return}if(!O.length&&!Q.length){j.textContent="",N(F),L&&(L.disabled=!0),P&&(P.disabled=!0);return}j.textContent=JSON.stringify(Ne(),null,2),de(F),L&&(L.disabled=!1),P&&(P.disabled=!1)}}function Et(e){const t=re(e);return Q.push({key:t,data:e}),q(),t}function kt(e,t){const n=r=>{const a=r.findIndex(i=>e&&i.key===e||i.data===t);return a!==-1?(r.splice(a,1),!0):!1};(n(Q)||n(O))&&q()}function St(){if(!u)return;const e=u.querySelector('[name="topic"]');if(e&&!e.value){const t=x.title||"Lesson topic";e.value=t}}function k(e,t="idle"){V&&(V.textContent=e,V.dataset.state=t)}function Tt(e){return String(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,8)}function X(e){return String(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function ue(){return Array.from(u.querySelectorAll('input[name="types"]'))}function vt(e){const t=e.filter(n=>n.checked).map(n=>{var o,r;return(r=(o=n.nextElementSibling)==null?void 0:o.textContent)==null?void 0:r.trim()}).filter(Boolean);return t.length?t.length<=2?t.join(", "):`${t.slice(0,2).join(", ")} +${t.length-2}`:"Оберіть типи"}function ae(){if(!S)return;const e=ue();S.textContent=vt(e)}function _(){!A||!S||Oe(A)||(N(A),S.setAttribute("aria-expanded","false"))}function Ct(){if(!A||!S)return;if(Oe(A)){de(A),S.setAttribute("aria-expanded","true");const t=A.querySelector('input[name="types"]');t==null||t.focus({preventScroll:!0})}else _()}function It(){const e=!me();localStorage.setItem("hideGenerateSection",String(e)),oe(),q()}function $t(){const e=document.getElementById("practice"),t=e==null?void 0:e.querySelector("#practice-body");if($e&&$e.remove(),t&&t.children.length===1){const n=t.firstElementChild;n&&/практика поки відсутня/i.test(n.textContent||"")&&n.remove()}}function Mt(){const e=document.getElementById("practice");if(!e)return;const t=e.querySelector("#practice-body");if(t&&!t.querySelector(".practice-dynamic-title")){const n=document.createElement("div");n.className="practice-dynamic-title",n.innerHTML=`
      <h2>Згенеровані завдання</h2>
      ${x.level?`<p class="muted">Рівень: ${x.level}</p>`:""}
    `,t.prepend(n)}}async function At(e){var v,E;if(e.preventDefault(),!u)return;const t=u.querySelector('button[type="submit"]'),n=u.querySelector('[name="topic"]'),o=u.querySelector('[name="count"]'),r=u.querySelector('[name="instructions"]'),a=ue(),i=(v=n==null?void 0:n.value)==null?void 0:v.trim(),s=Number.parseInt((o==null?void 0:o.value)||"10",10)||10,l=((E=r==null?void 0:r.value)==null?void 0:E.trim())||"",c=a.filter(d=>d.checked).map(d=>d.value);if(!i){k("Укажіть тему для генерації завдання.","error"),n==null||n.focus();return}if(!c.length&&typeof _=="function"){k("Оберіть принаймні один тип завдання.","error");return}const h=Tt(i)||"task";k(`Генеруємо ${c.length} тип(и) завдань…`,"loading"),t&&(t.disabled=!0,t.dataset.originalText=t.dataset.originalText||t.textContent,t.textContent="Генерація…"),String(x.category||"").toLowerCase();const g=void 0;try{const d=c.map(w=>ht(i,w,{items:s,language:"en",seedId:`${h}-${w}`,...l?{additionalInstructions:l}:{}},g).then(I=>({type:w,task:I}))),p=await Promise.allSettled(d),C=p.map((w,I)=>w.status==="fulfilled"?{type:c[I],task:w.value.task}:null).filter(Boolean),B=p.map((w,I)=>w.status==="rejected"?c[I]:null).filter(Boolean);if(!C.length)throw new Error("Не вдалося згенерувати жодного типу завдань");const D=[];C.forEach(({type:w,task:I})=>{const W={...I};W.id||(W.id=`${w}-${h}-${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`);const qe=Et(W);D.push({task:W,key:qe})}),$t(),window.practice&&typeof window.practice.appendTask=="function"&&(Mt(),D.forEach(({task:w,key:I})=>{window.practice.appendTask(w,{key:I})})),_();const pe=C.map(({type:w})=>w).join(", ");B.length?k(`Згенеровано: ${pe}. Помилки: ${B.join(", ")}`,"success"):k(`Готово! Додано ${C.length} блок(и): ${pe}.`,"success")}catch(d){console.error(d);const p=d instanceof Error&&d.message?`Помилка: ${d.message}`:"Не вдалося згенерувати завдання. Перевірте токен або спробуйте ще раз.";k(p,"error")}finally{if(t){const d=t.dataset.originalText||"Згенерувати завдання";t.disabled=!1,t.textContent=d}}}async function Ut(){if(!j)return;const e=j.textContent;if(e)try{await navigator.clipboard.writeText(e),k("JSON скопійовано у буфер.","success")}catch(t){console.error(t),k("Не вдалося скопіювати JSON. Спробуйте вручну.","error")}}function _t(e){return`${X(x.id)||X(e.title)||X(x.title)||"practice"||"practice"}.json`}async function Lt(){const e=Ne(),t=JSON.stringify(e,null,2);if(!t||t==="{}"||t==="[]"){k("Немає даних для завантаження.","error");return}try{const n=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(n),r=document.createElement("a");r.href=o,r.download=_t(e),document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(o),k("Файл завантажено.","success")}catch(n){console.error(n),k("Не вдалося завантажити файл.","error")}}function Pt(){if(u){if(St(),u.addEventListener("submit",At),L&&(L.addEventListener("click",Ut),L.disabled=!0),P&&(P.addEventListener("click",Lt),P.disabled=!0),S&&A&&z){S.setAttribute("aria-haspopup","true"),S.setAttribute("aria-expanded","false"),S.addEventListener("click",()=>{Ct()});const e=n=>{z.contains(n.target)||_()};document.addEventListener("pointerdown",e);const t=n=>{const o=n.relatedTarget;(!o||!z.contains(o))&&_()};z.addEventListener("focusout",t),document.addEventListener("keydown",n=>{n.key==="Escape"&&(_(),S.focus())}),ue().forEach(n=>{n.addEventListener("change",()=>{ae()})}),ae(),u.addEventListener("submit",()=>{_()})}document.addEventListener("practice:taskRemoved",e=>{const t=e.detail||{};kt(t.key,t.task)}),document.addEventListener("practice:dataLoaded",e=>{const t=e.detail;O.length=0,t&&Array.isArray(t.entries)?($=t.title??$,M=t.level??M,t.entries.forEach(({task:n,key:o})=>{const r=o||re(n);O.push({key:r,data:n})})):t&&Array.isArray(t.tasks)?($=t.title??$,M=t.level??M,t.tasks.forEach(n=>{const o=n&&n.id?String(n.id):re(n);O.push({key:o,data:n})})):t?($=t.title??$,M=t.level??M):($=x.title||$,M=x.level||M),q(),oe()}),oe(),q(),document.addEventListener("keydown",e=>{e.code&&e.code==="KeyH"&&e.ctrlKey&&e.shiftKey&&(e.preventDefault(),It())})}}Pt();
